...
public class Laser : Missile
{
    ...
    public override void LiveUpdate()
    {
        ...
        var toOberverSquared = (transform.position - Universe.Current.ViewPort.transform.position).sqrMagnitude;
    ...
    public void UpdateLineRenderer()
    {
        ...
        if (_hasHit && Vector3.Dot(headPosition - _hitPosition, transform.forward) > 0f)
        {
        ...
        if (Vector3.Dot(tailPosition - _shootFrom, transform.forward) < 0f)
        {
