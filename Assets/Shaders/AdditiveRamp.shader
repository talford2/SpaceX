...
////// Emissive:
                ...
                float3 emissive = (_Ramp_var.rgb*i.vertexColor.rgb*(1.0 - saturate((distance(i.posWorld.rgb,_WorldSpaceCameraPos)/_FadeDistance))));
