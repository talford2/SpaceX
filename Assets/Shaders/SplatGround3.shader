...
/*SF_DATA;ver:1.27;sub:START;pass:START;ps:flbk:,iptp:0,cusa:False,bamd:0,lico:1,lgpr:1,limd:3,spmd:1,trmd:0,grmd:0,uamb:True,mssp:True,bkdf:True,hqlp:False,rprd:True,enco:False,rmgx:True,rpth:0,vtps:0,hqsc:True,nrmq:1,nrsp:0,vomd:0,spxs:False,tesm:0,olmd:1,culm:0,bsrc:0,bdst:1,dpts:2,wrdp:True,dith:0,rfrpo:True,rfrpn:Refraction,coma:15,ufog:True,aust:True,igpj:False,qofs:0,qpre:1,rntp:1,fgom:False,fgoc:False,fgod:False,fgor:False,fgmd:0,fgcr:0.5,fgcg:0.5,fgcb:0.5,fgca:1,fgde:0.01,fgrn:0,fgrf:300,stcl:False,stva:128,stmr:255,stmw:255,stcp:6,stps:0,stfa:0,stfz:0,ofsf:0,ofsu:0,f2p0:False,fnsp:False,fnfb:False;n:type:ShaderForge.SFN_Final,id:2865,x:32719,y:32712,varname:node_2865,prsc:2|diff-1192-OUT,spec-358-OUT,gloss-1813-OUT;n:type:ShaderForge.SFN_Slider,id:358,x:32306,y:33274,ptovrint:False,ptlb:Metallic,ptin:_Metallic,varname:node_358,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,min:0,cur:0,max:1;n:type:ShaderForge.SFN_Slider,id:1813,x:32306,y:33395,ptovrint:False,ptlb:Gloss,ptin:_Gloss,varname:_Metallic_copy,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,min:0,cur:0,max:1;n:type:ShaderForge.SFN_Tex2d,id:7182,x:31719,y:32544,ptovrint:False,ptlb:Ground1,ptin:_Ground1,varname:node_7182,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,tex:69efe6cbea36ef6458cea4e36df6fb79,ntxv:0,isnm:False;n:type:ShaderForge.SFN_Tex2d,id:677,x:31719,y:32760,ptovrint:False,ptlb:Ground2,ptin:_Ground2,varname:node_677,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,tex:1408372681a33574d8a32ab31262b5bb,ntxv:0,isnm:False;n:type:ShaderForge.SFN_Lerp,id:4200,x:31972,y:32621,varname:node_4200,prsc:2|A-7182-RGB,B-677-RGB,T-366-R;n:type:ShaderForge.SFN_Tex2d,id:366,x:31697,y:33072,ptovrint:False,ptlb:Masks,ptin:_Masks,varname:node_366,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,tex:aa762ee7680f35f4fb9a9210fa94ce61,ntxv:0,isnm:False;n:type:ShaderForge.SFN_Tex2d,id:1504,x:31972,y:32814,ptovrint:False,ptlb:Ground3,ptin:_Ground3,varname:node_1504,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,tex:721a3664919b0774981cbfdbb38f6d21,ntxv:0,isnm:False;n:type:ShaderForge.SFN_Lerp,id:1482,x:32178,y:32736,varname:node_1482,prsc:2|A-4200-OUT,B-1504-RGB,T-366-G;n:type:ShaderForge.SFN_Tex2d,id:5908,x:32164,y:32928,ptovrint:False,ptlb:Ground4,ptin:_Ground4,varname:node_5908,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,tex:d9262c051e4665d45babc8ec0c813b59,ntxv:0,isnm:False;n:type:ShaderForge.SFN_Lerp,id:1192,x:32368,y:32850,varname:node_1192,prsc:2|A-1482-OUT,B-5908-RGB,T-366-B;proporder:358-1813-366-7182-677-1504-5908;pass:END;sub:END;*/

Shader "Shader Forge/SplatGround3" {
    Properties {
...
////// Specular:
                ...
                float3 diffuseColor = lerp(lerp(lerp(_Ground1_var.rgb,_Ground2_var.rgb,_Masks_var.r),_Ground3_var.rgb,_Masks_var.g),_Ground4_var.rgb,_Masks_var.b); // Need this for specular when using metallic
...
/// Final Color:
        ...
        Pass {
            ...
            float4 frag(VertexOutput i) : SV_Target {
                ...
                float4 _Ground3_var = tex2D(_Ground3,TRANSFORM_TEX(i.uv0, _Ground3));
                float4 _Ground4_var = tex2D(_Ground4,TRANSFORM_TEX(i.uv0, _Ground4));
                float3 diffColor = lerp(lerp(lerp(_Ground1_var.rgb,_Ground2_var.rgb,_Masks_var.r),_Ground3_var.rgb,_Masks_var.g),_Ground4_var.rgb,_Masks_var.b);
                float specularMonochrome;
                float3 specColor;
