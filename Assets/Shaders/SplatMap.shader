    ...
    SubShader {
        ...
        Pass {
            ...
            float4 frag(VertexOutput i) : COLOR {
                ...
                float3 normalLocal = lerp(lerp(lerp(lerp(lerp(_Normal1_var.rgb,_Normal2_var.rgb,_Masks_var.r),_Normal3_var.rgb,_Masks_var.g),_Normal4_var.rgb,_Masks_var.b),_Normal5_var.rgb,_Masks_var.a),float3(0,0,1),_NormalStrength);
