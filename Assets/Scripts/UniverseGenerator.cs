...
public class UniverseGenerator : MonoBehaviour
{
    ...
    void LateUpdate()
    {
        if (_hasStartedGenerating)
        {
            ...
            Debug.Log("Forward: " + ToStringV3(SunLight.transform.forward));
            Debug.Log("Rotation: " + ToStringV3(SunLight.transform.eulerAngles));
        }
    }
    ...
    private string ToStringV3(Vector3 v3)
    {
        return string.Format("({0:f6},{1:f6},{2:f6})", v3.x, v3.y, v3.z);
    }
