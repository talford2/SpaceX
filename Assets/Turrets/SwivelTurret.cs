...
public class SwivelTurret : MonoBehaviour
{
    [Header("Description")]
    public string Name;
    ...
    */
    ...
    private void Update()
    {
        ...
        */
        ...
        var targetYaw = Mathf.Clamp(GetLocalTargetEuler(Head.transform, _aimPosition).y % 360f, MinPitch, MaxPitch); // This is actually more like pitch
    ...
    private void OnDrawGizmos()
    {
        ...
        Gizmos.DrawLine(Head.transform.position, Head.transform.position + Head.transform.up * 10f);
        Gizmos.color = Color.green;
        Gizmos.DrawLine(Head.transform.position, Head.transform.position + Head.transform.right * 10f);
    }
}